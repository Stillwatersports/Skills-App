...
const CONTENT = {
  ...
  pricing_modal_success_p:          "We'll be in touch within 24 hours to discuss your booking details. Check your inbox — and spam just in case!",
  ...
  pricing_tip_halfday:  "<strong>Tip:</strong> Upgrading to a full day (2 sessions) gives everyone twice the time on the water.",
  ...
  sports_wakesurf_p2:  "Coaching covers getting up, finding the sweet spot in the wave, dropping the rope, and eventually shredding turns and tricks. The ballast bags and surf tabs on the Boat create an excellent wave for learning.",
  ...
  booking_gear_boat:           "Sanger Competition towboat — fully fuelled",
  ...
  guidelines_provided:    "Sanger Ski/wake boat · Fuel · Waterskis · Wakeboards · Wakesurf board · Combo skis · Trick skis · Slalom ski · Ropes · Handles · PFDs in all sizes · Barefoot boom · Wakeboard tower · Surf tabs · Ballast bags · First aid kit · Safety equipment",
  ...
  faq_a2:              "Everything. The boat, fuel, all equipment (skis, boards, ropes, handles, life jackets in all sizes), and coach time. The only additional costs are distance surcharges (more than 1.5 hours from Ottawa) and a $30/hr tubing surcharge. No hidden fees.",
  ...
  faq_a9:              "We travel across Ontario cottage country — Ottawa, Muskoka, Kawarthas, Rideau Lakes, Prince Edward County, Thousand Islands, and beyond. Distance surcharges apply. For locations further than 6hrs, <a href='/contact'>contact us</a> and we'll see what we can do.",
  ...
  faq_a13:             "Groups of all sizes are welcome. The Sanger boat accommodates up to 8 passengers comfortably. As a general guideline, plan for approximately 30 minutes per rider per session including setup — 1–2 sets each is plenty. Large groups can rotate riders throughout the day. There's no extra charge per person.",
