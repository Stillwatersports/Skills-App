...
const CONTENT = {
  ...
  pricing_dropin50_f1:       "Multiple spots along the Rideau River between Ottawa and Kemptville ",
  pricing_dropin50_f2:       "Guaranteed spot",
  pricing_dropin50_f3:       "Perfect for 2 people at $100 each (2 × 15 min turns each)",
 ...
 // Come to Us — $60/set drop-in
  ...
  pricing_cometo_desc:     "Come ride with us on the Rideau River or join an open time slot while we're already in your local area.",
  pricing_cometo_name:     "Meet us while we are out.",
  pricing_cometo_badge:    "💧 Get a Quick Pass in! ",
  pricing_cometo_duration: "Pay per Set - 15 min per set",
  pricing_cometo_f1:       "Grab a seat for one of our training sessions and take a pass - you come to us",
  ...
  pricing_base_desc:    "Morning and Evening time slots usually offer the best conditions due to reduced boat traffic and lower wind speeds. All packages include tax, boat, fuel, equipment, life jackets, and coach time. We come to you!",

  pricing_pkg1_name:    "Single Session - Best for Learning for the first time",
