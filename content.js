...
const CONTENT = {
  ...
  business_location:    "Manotick, Ottawa ON",
  business_season:      "May through September",
  footer_desc:          "Private water sports coaching across Ontario cottage country. Six disciplines, all skill levels, all equipment included.",
  footer_copy:          "© 2026 Christian Richards · Stillwater Sports · All rights reserved",
  footer_region:        "Ontario Cottage Country · learnwatersports.ca",
  ...
  home_hero_sub:        "Private coaching across Ontario cottage country — Ottawa · Muskoka · Kawarthas · Prince Edward County · Rideau Lakes · Thousand Islands · and beyond.",

  home_offers_eyebrow:  "01 · What's Offered",
  home_offers_h2_1:     "Everything you need",
  home_offers_h2_2:     "to get up and ride.",
  home_offers_desc:     "Every session is private, tailored to your group, and built around real progression — not just splashing around. Our system guarantees everyone gets up the first run.",
  ...
  home_offer3_text:     "Half-day and full-day options for the whole family at the cottage. Kids welcome. Safe, structured, and a lot of fun.",
  ...
  home_offer6_text:     "All students get access to the Stillwater Skills app — earn Bronze to Platinum badges and track progress all season long.",

  home_sports_eyebrow:  "02 · Sport Matrix",
  home_sports_h2_1:     "Riders Choice.",
  home_sports_h2_2:     "Try them all or master one!",
  home_sports_desc:     "Six disciplines. Structured progression from first-timer to advanced. Click any card to explore.",
  ...
  home_booking_location:"Tell us where you are. We handle the drive, the launch, all of it.",
  home_booking_pricing: "See our <a href='/pricing'>pricing page</a> for full details. Starting from $550.",
  ...
  pricing_pkg1_f1:      "Morning or afternoon session",
  pricing_pkg1_f2:      "All equipment included",

  pricing_pkg2_name:    "Full Day",
  pricing_pkg2_price:   "850",
  pricing_pkg2_duration:"7 hrs on water · 1hr lunch break",
  pricing_pkg2_f1:      "AM + PM sessions",
  pricing_pkg2_f2:      "1 hour lunch break",
  pricing_pkg2_f3:      "Ideal for families & groups",

  pricing_pkg3_name:    "Weekend / Holiday Day",
  pricing_pkg3_price:   "1,000",
  pricing_pkg3_duration:"7 hrs · Sat, Sun or stat holiday",
  pricing_pkg3_f1:      "Saturdays, Sundays & stat holidays",
  pricing_pkg3_f2:      "Minimum full day",

  pricing_pkg4_name:    "Full Weekend",
  pricing_pkg4_price:   "1,800",
  pricing_pkg4_duration:"14 hrs · Sat + Sun",
  pricing_pkg4_f1:      "Saturday + Sunday back to back",
  pricing_pkg4_f2:      "Best for cottage weekends",

  pricing_pkg5_name:    "Holiday Weekend (3 Days)",
  pricing_pkg5_price:   "2,350",
  pricing_pkg5_duration:"21 hrs · Sat + Sun + stat holiday",
  pricing_pkg5_f1:      "3-day long weekend package",
  pricing_pkg5_f2:      "Sat, Sun + stat holiday",
  ...
  pricing_multi1_price: "1,600",
  pricing_multi1_dur:   "Back to back · best value",
  pricing_multi1_f1:    "$800/day",
  pricing_multi1_f2:    "Booked on consecutive days",

  pricing_multi2_name:  "2 Days — Spread",
  pricing_multi2_price: "1,900",
  pricing_multi2_dur:   "Any 2 days across the season",
  pricing_multi2_f1:    "$950/day",
  pricing_multi2_f2:    "Subject to availability",

  pricing_multi3_name:  "3 Days — Consecutive",
  pricing_multi3_price: "2,300",
  pricing_multi3_dur:   "Back to back · great for skill camps",
  pricing_multi3_f1:    "$766/day",
  pricing_multi3_f2:    "Booked on consecutive days",

  pricing_multi4_name:  "5 Days — Consecutive",
  pricing_multi4_price: "3,500",
  pricing_multi4_dur:   "Mon–Fri or similar · best value",
  pricing_multi4_f1:    "$700/day",
  pricing_multi4_f2:    "Immersive week-long progression",

  pricing_multi5_name:  "5 Days — Spread",
  pricing_multi5_price: "3,750",
  pricing_multi5_dur:   "Any 5 days across the season",
  pricing_multi5_f1:    "$750/day",
  ...
  pricing_surcharge_dist1:     "+$100 flat — 1.5–3hr drive from Manotick, ON.",
  pricing_surcharge_dist2:     "+$200 flat — 3–6hr drive from Manotick, ON.",


  // ── SPORTS PAGE ───────────────────────────────────────
  sports_hero_badge:    "All Disciplines · One Coach",
  sports_hero_l1:       "Pick your",
  sports_hero_l3:       "discipline.",
  ...
  sports_wakesurf_h2:   "Drop the rope… And surf.",
  ...
  sports_barefoot_h2:   "No skis. Just feet.",
  ...
  how_step1_eyebrow:    "First Step",
  how_step1_h2_1:       "Request a date",
  how_step1_h2_2:       "online.",
  how_step1_p1:         "Head to the booking page, pick an open date on the live calendar, and fill in your details — your name, lake or cottage area, group size, sport, and skill level. The whole thing takes about 2 minutes.",
  how_step1_p2:         "No phone calls needed. No back-and-forth emails. Just submit your request and we take it from there.",

  how_step2_eyebrow:    "Within 24 Hours",
  how_step2_h2_1:       "We confirm",
  how_step2_h2_2:       "and plan.",
  how_step2_p1:         "Within 24 hours we will reach out to confirm the date, discuss your group's goals, choose the best spot on your lake, and tailor a session plan around your skill levels and interests.",
  ...
  how_step4_p1:         "On the day of your session we arrive at your lake with everything — the Sanger DLX boat, all equipment, life jackets, and a structured plan ready to go. You don't need to bring a single thing except yourselves.",
  ...
  how_step5_p2:         "After your session, all Stillwater Sports students get access to the Stillwater Skills app — track your progress, earn Bronze through Platinum badges, and pick up exactly where you left off next time!",

  how_faq1_q:           "Do I need my own boat or lake access?",
  how_faq1_a:           "No! No boat required, we bring our own. Typically we go to our clients cottage however we can arrange to meet at a public park on a lake near you, or come to us. We also run on the Rideau River in Ottawa. Distance surcharges apply for locations 1.5+ hrs from Manotick.",
  ...
  contact_response_note:"Usually same day during season (May–Sept)",
  ...
  app_feat1_title:      "Bronze → Platinum Progression",
