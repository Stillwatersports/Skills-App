...
const CONTENT = {
  ...
  about_cred3_title:   "CWSIC Certified",
  about_cred3_text:    "The foundational Canadian waterski instructional certification covering technique, teaching methodology, and on-water instruction from beginner through advanced.",
  about_cred4_title:   "Competitive Barefoot Athlete",
  ...
  about_cred5_title:   "Board Member — WSWC",
  ...
  pricing_hero_l1:      "What does it cost",
  pricing_hero_l3:      "per person?",
  pricing_hero_sub:     "Pick your dates below and we'll calculate your per-person price and full breakdown on the spot.",
  pricing_hero_scroll:  "Estimate Below",
  pricing_stat1_num:    "$50",
  pricing_stat1_lbl:    "Local drop-in / turn",
  pricing_stat2_num:    "~$150",
  pricing_stat2_lbl:    "Per person / day",
  pricing_stat3_num:    "100%",
  pricing_stat3_lbl:    "Gear included",

  // Pass / Turn / Block explainer
  pricing_ptb_eyebrow:  "How a session works",
  pricing_ptb_h2_1:     "Pass, Turn,",
  pricing_ptb_h2_2:     "Block.",
  pricing_ptb_pass_num:  "01",
  pricing_ptb_pass_title:"Pass",
  pricing_ptb_pass_desc: "A single run behind the boat — typically 3 to 4 minutes. A complete turn is made up of 6–8 passes, giving each rider a chance to practice, rest, and go again before wrapping up their turn.",
  pricing_ptb_turn_num:  "02",
  pricing_ptb_turn_title:"Turn",
  pricing_ptb_turn_desc: "One person's full time on the water — 20 to 30 minutes including occasional stops for coaching notes. Each turn is 6–8 passes. Most riders do 1–2 turns per block depending on group size and energy level.",
  pricing_ptb_block_num: "03",
  pricing_ptb_block_title:"Block",
  pricing_ptb_block_desc:"Morning, Afternoon, or Evening — each block is 4 hours. We fit 2–3 turns per hour. A full day uses any 2 of the 3 blocks. In a 6-person group, everyone gets roughly 2 turns per block.",

  // Four tier cards
  pricing_tiers_eyebrow: "Four ways to ride",
  pricing_tiers_h2_1:    "Find your",
  pricing_tiers_h2_2:    "starting point.",
  pricing_tiers_desc:    "Every booking includes the boat, all equipment, fuel, and full coaching time. Use the estimator below for your exact price.",
  pricing_tier_cta:      "Estimate My Price →",

  pricing_tier1_eyebrow: "Half Day · 4 hours",
  pricing_tier1_name:    "Single Session",
  pricing_tier1_desc:    "One 4-hour block — morning, afternoon, or evening. Perfect for a first experience or when you only need a few hours. Everyone gets solid time on the water.",

  pricing_tier2_eyebrow: "Full Day · We come to you",
  pricing_tier2_name:    "Full Day",
  pricing_tier2_desc:    "Any 2 of the 3 blocks. Morning + afternoon, afternoon + evening, or upgrade to the split day (morning + evening, +$250) for the glassiest water of the day. Best value for groups of 4–6.",
  pricing_tier2_split_label: "Add split day (morning + evening) +$250",
  pricing_tier2_split_tip:   "⭐ Best conditions — water is glassiest in the early morning and evening. Worth every penny.",
  ...
  // Group size guide
  pricing_group_eyebrow: "Group sizing guide",
  pricing_group_h3:      "What's the right group size?",
  pricing_group_desc:    "Your group size directly affects how much time each person gets on the water — and your per-person cost.",
  pricing_gs1_label:     "Solo or Pair",
  pricing_gs1_desc:      "Drop-In is your best option — $50/turn, no boat travel. Or split a single session at $300/person.",
  pricing_gs1_tip:       "→ Drop-In or Half Day",
  pricing_gs2_label:     "Small Group",
  pricing_gs2_desc:      "A half day splits well at $150–$200/person. Everyone gets 2 solid turns. Adding a 4th person drops cost significantly.",
  pricing_gs2_tip:       "→ Half Day or Full Day",
  pricing_gs3_label:     "Sweet Spot ★",
  pricing_gs3_desc:      "The ideal size. Boat runs efficiently, everyone gets 2 turns per block, per-person cost drops to $167–$200 for a full day.",
  pricing_gs3_tip:       "→ Full Day or Multi-Day",
  pricing_gs4_label:     "Large Group",
  pricing_gs4_desc:      "Still great — turns rotate faster. Consider booking 2 full blocks so no one waits long between turns.",
  pricing_gs4_tip:       "→ Full Day · 2 blocks",

  // Estimator UI labels
  pricing_est_eyebrow:              "Price Estimator",
  pricing_est_h2_1:                 "Estimate your",
  pricing_est_h2_2:                 "price.",
  pricing_est_desc:                 "Select your session type, riders, and dates — we'll calculate your best-fit package and full breakdown. No commitment required.",
  ...
  equip_feat3_text:    "A solid bar extending out the driver's side of the boat. Originally designed for barefoot water-skiers, it quickly evolved into an excellent teaching tool for all disciplines. Height adjustable for all ages. Even the best waterskier in the world still hones their skills on the boom!",
  ...
  equip_feat5_text:    "Adjustable wake shaping tabs for wakesurf sessions. Dial in the exact wave shape and size — from mellow and forgiving for beginners to steep and powerful for advanced surfers.",
  equip_feat6_title:   "Ballast Bags",
  equip_feat6_text:    "Weighted ballast bags to increase displacement and create a larger, more pronounced wake for wakeboarding and wakesurfing.",
  ...
  app_hero_l1:         "Track every skill.",
  app_hero_l3:         "Earn every badge.",
  app_main_h2_1:       "The progression platform for",
  app_main_h2_2:       "mastering all water sports.",
  app_main_desc:       "Built from the ground up for waterski, wakeboard, wakesurf, slalom, and barefoot — Stillwater Skills gives athletes a structured and logical path from beginner to expert, with coach sign-offs at every stage.",
  app_feat1_title:     "Bronze → Gold Progression",
  app_feat1_text:      "Structured skill tiers that lock until you complete the level below. Real learning paths — not cherry-picked tricks.",
  app_feat2_title:     "Coach Approval Queue",
  app_feat2_text:      "Athletes submit skills for approval. Coaches review, approve or reject with notes — all from the app.",
  app_feat3_title:     "Video Submission",
  app_feat3_text:      "Athletes attach a video when submitting a skill. Coaches review footage before approving. Evidence-based progression.",
  app_feat4_title:     "GPS Session Tracking",
  app_feat4_text:      "Track runs, distance, and top speed every session. Build a full history of time on the water over the season.",
  app_feat5_title:     "Leaderboard & Social",
  app_feat5_text:      "Club leaderboards, friend connections, and shareable skill profiles. Friendly competition drives motivation.",
  app_feat6_title:     "Safety Certifications",
  app_feat6_text:      "Built-in dryland safety quiz, driver certification, and advanced safety modules. Unlock water skills only after safety is confirmed.",
  app_clubs_eyebrow:   "For Clubs & Schools",
  app_clubs_h2_1:      "The digital backbone",
  app_clubs_h2_2:      "your club is missing.",
  app_clubs_desc:      "Stillwater Skills is available as a standalone SaaS platform for water sports clubs, schools, and coaching programs across Canada and the USA. Full club management system that keeps members engaged and connected.",
  ...
  guidelines_age_l2:      "Children under 16 must have a <strong>parent or guardian present on shore at all times</strong>",
  ...
  guidelines_req_l1:      "Swimwear",
  guidelines_req_l2:      "Sunscreen — apply before boarding",
  guidelines_req_l3:      "Water & snacks for your group",
  guidelines_req_l4:      "Towels",
  guidelines_req_l5:      "Signed waivers (sent after booking)",
  guidelines_opt_h3:      "Optional but Recommended",
  guidelines_opt_l1:      "Your own life jacket — we have all sizes but yours fits better",
  guidelines_opt_l2:      "Your own ski, board, or handle",
  guidelines_opt_l3:      "Rash guard or UV protection",
  guidelines_opt_l4:      "Warm layer for morning/evening sessions",
  ...
  guidelines_pfd_l1:      "A properly fitting PFD must be worn by every rider while in the water — no exceptions",
  guidelines_pfd_l2:      "Children under 16 must wear a PFD on the boat as well",
  guidelines_pfd_l3:      "Exceptions are limited to advanced disciplines such as barefooting or trick skiing, at the coach's discretion per Transport Canada guidelines",
  guidelines_spotter_h3:  "Spotter / Observer",
  guidelines_spotter_l1:  "A designated spotter must face the rider at all times while they are in the water",
  guidelines_spotter_l2:  "Hand signals are reviewed at the start of each session: thumb up, thumb down, OK, stop, emergency",
  guidelines_water_rules_h3: "In the Water",
  guidelines_water_r1:    "Always hold your ski(s) or board up out of the water after a fall — signals your location to the driver and other boaters",
  guidelines_water_r2:    "Stay visible — do not swim toward the boat until instructed by the coach",
  guidelines_water_r3:    "After a fall, give the appropriate signal — OK or NOT OK. The boat will return slowly to pick you up",
  guidelines_water_r4:    "Never approach the boat near the propeller — wait for the all-clear signal",
  guidelines_boat_h3:     "On the Boat",
  guidelines_boat_l1:     "Remain seated while the boat is at speed",
  guidelines_boat_l2:     "No standing or sitting on the bow, gunwales, or tower while underway",
  guidelines_boat_l3:     "Food & drinks — snacks and water are strongly encouraged. Please avoid messy foods: chips, Cheetos, fruit punch. Fruit, granola bars, sandwiches, and water/Gatorade are all welcome",
  ...
  guidelines_weather_l1:  "<strong>Light rain</strong> — session proceeds as scheduled",
  guidelines_weather_l2:  "<strong>Heavy rain or thunder</strong> — session cancelled by coach, full credit to rebook",
  guidelines_weather_l3:  "<strong>Overcast or wind only</strong> — session proceeds; if conditions deteriorate, pro-rated credit for remaining time",
  guidelines_weather_l4:  "If no suitable rebook date before September 30 — full refund of all payments made",
  guidelines_weather_l5:  "The coach has final say on all weather-related decisions",
  ...
  guidelines_app_l2:      "Track your skills from Bronze through Gold — complete Gold to unlock the secret Platinum level",
  guidelines_app_l3:      "Submit videos for coach approval and sign-off on each skill",
  ...
  faq_q8:              "What does the launch need to be like?",
  faq_a8:              "A concrete or gravel trailer ramp is ideal. We arrive with a full-size ski boat and trailer, so the launch must accommodate both with parking for the truck and trailer. Any culverts, bridges, or locks on the route require a minimum 8 feet of clearance. If you're unsure, send us a description and we'll confirm.",
  faq_q9:              "How far will you travel?",
  ...
  faq_q18:             "Can we do multiple sports in one session?",
  faq_a18:             "Yes — mix and match across the day. You can waterski in the morning, wakeboard in the afternoon, and throw in some tubing. The session plan is built around your group's interests and we'll make recommendations based on what we think you'll enjoy most.",
  faq_q19:             "What disciplines do you offer?",
